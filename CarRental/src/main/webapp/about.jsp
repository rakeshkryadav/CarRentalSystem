              ...
              <div class="row">
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    <span>Car Rent.com</span>
                    <h2>Get to know about <em>our company</em></h2>
                    <p>At CarRent.com everything we do is about giving you the freedom to discover more. We’ll move mountains to find you the right rental car, and bring you a smooth, hassle-free experience from start to finish. Here you can find out more about how we work. 
                    </p>
                  </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left-content">
              <span>About Us</span>
              <h2>Summer Training  <em>Project</em></h2>
              <p>Project For Summer Training of Bachelors's in Computer Application (BCA) in Advance JAVA <br> INSTITUTE OF INNOVATION IN TECHNOLOGY & MANAGEMENT (IITM)</p>
            </div>
          </div>
          <div class="col-md-6 align-self-center">
            <div class="row">
